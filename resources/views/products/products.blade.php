              ...
              {!! Form::open(array('url' => '/admin/products/list', 'class' => 'form-horizontal')) !!}
                ...
                <div class="rows">
                   ...
                   <div class="col-sm-3" style="padding-left: 0px;padding-right: 0px">
                    {!! Form::text('search','',array('style'=>'width:100%','class'=>'form-control', 'id'=>'search','placeholder'=>trans('products.search'))) !!}
              </div>
              <div class="col-sm-9 pull-left" style="padding-right: 0px; padding-left: 0px;">
                 <a href="/admin/products/add" >
                {!! Form::button( trans('products.add'),array('class' => 'btn btn-primary bnt-sm pull-right; fa fa-plus','id'=>'addproduct','style'=>'float:right;height:34px;margin-bottom:5px;margin-top:5px')) !!}
              </a>
              </div>
